...
Figure~\ref{fig-simple-tree}. The resulting tree has 7 nodes: nodes 0, 1, 2, and 3 are \emph{leaves}, and
represent our samples. Node 4 is an \emph{internal} node, and is the
