...
The histograms display empirical frequencies binned by segment length, while the 
overlaid curves represent kernel density estimates that provide smooth, continuous 
approximations of the underlying probability density functions.
