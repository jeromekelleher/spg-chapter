...
population sizes mean older coalescence times:
...
When comparing simulations to analytical results regarding, it is very important to be aware of the way in which the
...
completes, we then see that such rare alleles are very common. (We reiterate that \msprime assumes a simple infinite sites mutation model that each mutation occurs at a unique site. However, it is possible to have more complex situations such as
...
\texttt{pylibseq}~\citep{thornton2003libsequence} libraries.
