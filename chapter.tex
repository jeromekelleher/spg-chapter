...
We emphasise integration with existing Python data analysis toolkits
such as NumPy~\citep{walt2011numpy}, SciPy~\citep{jones-2018-scipy},
Jupyter Notebooks~\citep{perez2007ipython},
Matplotlib~\citep{hunter2007matplotlib}, Pandas~\citep{mckinney2010data}
and Seaborn~\citep{michael_waskom_2017_883859}.
...
\begin{center}
    \parbox{5cm}{
    \includegraphics[width=5cm]{images/segsites-example_5_0}
    \begin{center}(A)\end{center}
    }%
    \qquad
    \parbox{5cm}{
    \includegraphics[width=5cm]{images/segsites-example_7_0}
...
\begin{center}
    \parbox{5cm}{
    \includegraphics[width=5cm]{images/segsites-example_9_0}
    \begin{center}(A)\end{center}
    }%
    \qquad
    \parbox{5cm}{
    \includegraphics[width=5cm]{images/segsites-example_12_0}
    \begin{center}(B)\end{center}
    }
