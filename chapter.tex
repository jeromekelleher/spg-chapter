...
constant time, and so it is \emph{very} efficient. We see that such rare alleles are common. (We reiterate that \msprime\
generates mutations under the infinitely many sites model so that each mutation occurs at a
unique site. In more complex situations where we have back or recurrent mutations, this simple approach will not work.)
