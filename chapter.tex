...
genetic map for chromosome 22 (blue) and the density of breakpoints for a
simulated chromosome (green).}
\end{figure}
...
The \msprime\ API provides an extremely efficient way to count the number of
...
completes, we then see that such rare alleles are common. (We reiterate that \msprime\
...
\qquad\qquad
\subfloat[][
The full simulated and predicted distribution of total branch lengths for $n = 20$.
]{
