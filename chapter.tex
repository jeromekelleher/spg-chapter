...
efficient encoding of  history of a sample, often referred
to as an Ancestral Recombination Graph or ARG~\citep{wong2024general} 
(see the Discussion).
...
algorithms (see Section~\ref{processing-results} for more details)
...
and applicability. 
Recent work~\citep{kelleher2018efficient,haller2018tree} has shown
